                        ...
                        <div className="w-full border-none">
                            ...
                            <div className="w-full sm:flex sm:items-center sm:justify-between mt-8 border-t pt-8">
                                ...
                                <div className="mt-4 flex space-x-6 sm:mt-0 sm:justify-center">
                                    <Footer.Icon href="#" icon={BsFacebook} className='text-darkPurple' />
                                    <Footer.Icon href="#" icon={BsInstagram} className='text-darkPurple' />
                                    <Footer.Icon href="#" icon={BsTwitter} className='text-darkPurple' />
                                    <Footer.Icon href="#" icon={BsGithub} className='text-darkPurple' />
                                </div>
                            </div>
                        </div>
                    </Footer>
